...
router.get('/Writer/Image', function(req, res) { 
	...
	var Image = GetImageByWriter([WriterID, WriterName, WriterType, StaffingType, ImageID, ContentID]);
	res.json({info: Image});
}); 
...
router.get('/Writer/Content', function(req, res) { 
	...
	var Content = GetContentByWriter([WriterID, WriterName, WriterType, StaffingType, ImageID, ContentID]);
