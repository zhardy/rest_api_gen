...
router.get('/CraftSession/Content', function(req, res) { 
	...
	var Content = GetContentByCraftSession([CraftSessionID, CraftSessionName, ContentID, WriterID]);
...
router.get('/CraftSession/Writer', function(req, res) { 
	...
	var Writer = GetWriterByCraftSession([CraftSessionID, CraftSessionName, ContentID, WriterID]);
